...
void GenGeom2D::init_rotor ()
{
    ...
    rot_par.pin_arg                 = (1-rot_par.slot_part)*rot_par.slot_pin_angle;
    rot_par.slot_arg                = rot_par.slot_part *rot_par.slot_pin_angle;
...
void GenGeom2D::init_stator()
{
    ...
    stat_par.pin_arg                = (1-stat_par.slot_part)*stat_par.slot_pin_angle;
    stat_par.slot_arg               = stat_par.slot_part *stat_par.slot_pin_angle;
